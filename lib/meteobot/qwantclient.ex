defmodule Qwantclient do
  ...
  def request(query) do
    url = URI.encode("https://api.qwant.com/api/search/web?count=10&device=mobile&extensionDisabled=true&safesearch=1&locale=ru_RU&q=#{query}&t=web", &URI.char_unreserved?/1)
